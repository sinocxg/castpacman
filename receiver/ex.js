...
(function () {
    var f = true,
        i = null,
        j = false,
        l = window.google.ac = {}, aa = j,
        m, ba, ca, da, ea, fa, ga, ha, ia, n, o, p, ja, q = "",
        ka = i,
        r = i,
        s = i,
        u = -1,
        v, w, x, z, A, la, C, D, E, ma, na, pa, H, qa, ra = {}, sa, I = 0,
        K = 0,
        ta = j,
        L = i,
        M = 0,
    ...
    function lb(a) {
        for (var b = 0, c; c = W(b++);) if (za(c.m) == "p" && c.j == a[0]) {
            ...
            c.v.innerHTML = "该搜索已从您的\x3ca href\x3d\x22/history\x22\x3e网络历史记录\x3c/a\x3e中删除"
        }
    }
    ...
    function rb(a) {
        var b = a ? "\x26nbsp;手气不错\x26nbsp;" : "Google 搜索",
            c = "gac_sb",
            d = "",
            e = "";
        if (n) {
    ...
    function vb(a, b, c) {
        Q && Q.readyState != 0 && Q.readyState != 4 && Q.abort();
        if (Q) Q.onreadystatechange = function () {};
        if (Q = wb()) {
            Q.open("GET", a + "&xhr=t&q=" + b + "&cp=" + N, f);
            Q.onreadystatechange = function () {
                if (Q.readyState == 4) switch (Q.status) {
                    case 403:
                        R = 1E3;
                        break;
                    case 302:
    ...
    Db = {
        ...
        e: function (a, b, c) {
            ...
            if (fa && za(b) == "p") {
                a.className = "";
                a.innerHTML = ["<table cellpadding=0 cellspacing=0 border=0 class=gac_t><tr><td class=gac_c>", d, '<td class="gac_d gac_e fl"><a href=# onclick="return google.ac.dc(event,\'', b, "')\">删除</a></table>"].join("");
            }
        }
    }, Eb = {
        g: 19,
...
(function () {
    var h = "/intl/zh-CN/images/toolbar_animation_20090618.png",
        i = 52,
        j = 37,
        l = 75,
        m = 100;
    ...
    var o = [n("http://www.google.com.hk/videohp", "\u89c6\u9891", "\u641c\u7d22\u70ed\u95e8\u7f51\u7edc\u89c6\u9891", "#54a70d", [2, 5]), n("http://images.google.cn/", "\u56fe\u7247", "\u641c\u7d22\u5168\u7403\u7684\u56fe\u7247", "#3b79e7", [2, 5]), n("http://www.google.cn/gouwu", "\u8d2d\u7269", "\u641c\u7d22\u5546\u54c1\u548c\u8d2d\u7269\u4fe1\u606f", "#d93c08", [3, 7]), n("http://ditu.google.cn/", "\u5730\u56fe", "\u67e5\u8be2\u5730\u5740\u3001\u635c\u7d22\u5468\u8fb9\u548c\u89c4\u5212\u8def\u7ebf", "#e8d40f", [4, 9]), n("http://www.google.cn/music/homepage",
        "\u97f3\u4e50", "\u641c\u7d22\u548c\u53d1\u73b0\u97f3\u4e50", "#3b92e7", [3, 7]), n("http://translate.google.cn/", "\u7ffb\u8bd1", "\u5728\u7ebf\u7ffb\u8bd1\u5916\u6587\u6bb5\u843d\u3001\u7f51\u9875\u3001\u641c\u7d22\u7ed3\u679c", "#54a70d", [2, 5]), n("http://www.265.com/", "265\u5bfc\u822a", "\u5b9e\u7528\u7f51\u5740\u5927\u5168\uff0c\u4fbf\u6377\u76f4\u8fbe\u5e38\u7528\u7f51\u7ad9", "#ea7408", [2, 5])],
        p = [];
    ...
    function r(b, a) {
        return function (d) {
            ...
            d = d.relatedTarget || (e ? d.fromElement : d.toElement);
            var g = !d || q(c.element, d);
            f = q(c.element, f);
            if (e && !g || !e && (!d || f && !g)) {
                c = c.icon;
                c.mouseTimeout = window.clearTimeout(c.mouseTimeout);
                f = e ? 1 : -1;
                if (c.b != f) c.mouseTimeout = window.setTimeout(c.d(f, undefined), e ? m / 3 : m)
            }
        }
    }
    function s(b, a, d) {
        google.bind(b, a, r(a, d))
    }
    ...
    function t(b, a, d) {
        ...
        var c = document.createElement("div"),
            e = b.color,
            f = "background-color:" + e,
            g = "width:1px;height:1px;" + f + ";float:";
        g = '<div style="height:1px;overflow:hidden"><div style="' + g + 'left"></div><div style="' + g + 'right"></div></div>';
        f = "margin:0 1px;height:1px;overflow:hidden;" + f;
        c.innerHTML = '<div style="display:none;position:absolute;top:0;left:0;z-index:2;background:#fff;cursor:pointer;cursor:hand"><a href="' + a + '" style="color:#444;text-decoration:none" target=_blank><div style="' + f +
            '"></div><div style="text-align:center;border-left:1px solid;border-right:1px solid;border-color:' + e + '">' + g + '<div style="margin:0 auto;white-space:nowrap;padding:.2em 0 0"><span style="font-size:83%">' + d + "</span></div>" + g + '</div><div style="' + f + '"></div><div style="height:4px" align="center"><div style="position:relative;top:-1px;z-index:3;width:8px;overflow:hidden;margin:0 auto;height:4px;background:no-repeat -260px ' + -b.spriteCoordinateList[0].y + 'px"></div></div></a></div>';
        this.h = c.getElementsByTagName("span")[0];
        document.body.appendChild(c);
        c.firstChild.firstChild.lastChild.firstChild.style.backgroundImage = "url(" + h + ")";
        this.element = c.firstChild;
        a = p.length;
        p.push({
            icon: b,
            element: this.element
        });
        s(this.element, "mouseover", a);
        s(this.element, "mouseout", a)
    }
    t.prototype.play = function (b) {
        for (var a = this.c.element.firstChild, d = {
            left: -a.offsetLeft,
            top: 0
        }; a;) {
            d.left += a.offsetLeft;
        ...
        var c = this.element.offsetHeight,
            e = this.h.offsetWidth + 14;
        if (a.visibility == "hidden") {
            a.display = "none";
            a.visibility = "visible"
        }
        a.width = e + "px";
        d.left -= (e - this.c.element.parentNode.offsetWidth) / 2;
        d.top -= c - 3;
        d.top += 20 * Math.pow(1 - b / this.c.frames, 3);
        a.left = d.left + "px";
        a.top = d.top + "px";
        if (b == 0 || this.c.b < 0) a.display = "none";
        else {
            a.display = "";
            b = b / this.c.frames;
            if ("opacity" in a) a.opacity = b;
            else if ("MozOpacity" in a) a.MozOpacity = b;
            else if ("KhtmlOpacity" in a) a.KhtmlOpacity = b;
            else if ("filter" in a) a.filter = "alpha(opacity=" + b * 100 + ")"
        }
    };

    function u(b, a, d, c, e) {
        this.element = b;
        this.frames = a.length - 1;
        this.spriteCoordinateList = a;
        this.color = d;
        this.g = b.getElementsByTagName("div")[1];
        this.i = new t(this, c, e);
        this.b = -1;
        this.a = 1;
        a = p.length;
        p.push({
    ...
    u.prototype.d = function (b, a) {
        var d = this;
        return function () {
            d.f(b, a)
        }
    };
    u.prototype.f = function (b, a) {
        if (b) {
            this.b = b;
            this.mouseTimeout = window.clearTimeout(this.mouseTimeout);
            this.e = window.clearTimeout(this.e)
        }
        if (typeof a != "undefined") this.a = a;
        b = this.spriteCoordinateList[this.a];
        this.g.style.backgroundPosition = -b.x + "px " + -b.y + "px";
        this.i.play(this.a);
        b = this.element.getElementsByTagName("span")[0].style;
        if (this.b < 0) {
            b.color = "#444";
        ...
        else this.e = window.setTimeout(this.d(undefined, undefined), l)
    };
    google.y.first.push(function () {
        ...
        if (b) {
            ...
            for (var d = '<table style="margin:2em auto;border-collapse:collapse;line-height:1.4em" cellpadding="3" cellspacing="2" border="0"><tr>', c = 0; c < o.length; ++c) {
                var e = o[c];
                e.url = "/url?ct=pro&cd=" + c + "&source=cwh&q=" + encodeURIComponent(e.url);
                for (var f = [], g = j * c, k = 0; k < 7; ++k) k > 4 ? f.push({
                    x: i * 4,
                    y: g - e.yAdjust[k - 5]
                }) : f.push({
                    x: i * k,
                ...
                e.coordinates = f;
                d += '<td valign=bottom style="text-align:center;padding:0 .35em 0 .4em;margin:0;cursor:pointer;cursor:hand"><a style="color:#444;text-decoration:none;vertical-align:bottom" href="' + e.url + '" target=_blank><div><div style="width:52px;height:37px;margin:.5em auto;cursor:pointer;cursor:hand;background:no-repeat 0 ' + -g + 'px"></div><span style="white-space:nowrap;line-height:26px;font-size:83%">' + e.name + "</span></div></a></td>"
            }
            d += "</tr></table>";
            b.innerHTML = d;
            b = b.getElementsByTagName("a");
            for (c = 0; c < b.length; ++c) {
                b[c].firstChild.firstChild.style.backgroundImage = "url(" + h + ")";
                new u(b[c], o[c].coordinates, o[c].color, o[c].url, o[c].tooltip)
            }
        }
    });
})();
(function () {
    ...
    function v(a) {
        if (!a.e.l) {
            a.e.l = "\x3cfont color\x3dred\x3e错误：\x3c/font\x3e服务器无法完成您的请求。请在 30 秒后再次尝试。";
            a.G = a.a.onclick;
    ...
    function y() {
        ...
        if (!a.getAttribute("data-loaded")) {
            ...
            for (var e = 0, f = google.Toolbelt.atg.length; e < f; ++e) {
                ...
                for (var n;
                (n = google.Toolbelt.pbt[c]) && n[0] == e; c++) {
...
(function () {
    ...
    var qa = -1,
        Z, ra = {
            ...
            ShortMonth: "%b",
            MonthDay: "%b%d日",
            FullDate: "%Y年%b%d日 %I:%M:%S %p"
        }, sa = ["1月", "2月", "3月", "4月", "5月", "6月", "7月", "8月", "9月", "10月", "11月", "12月"],
        ta = ["1 月", "2 月", "3 月", "4 月", "5 月", "6 月", "7 月", "8 月", "9 月",
            "10 月", "11 月", "12 月"];
    ...
    function wa(a, c) {
        var b = c - a;
        if (b < 86400) if (b < 45) return "秒前";
        else if (b < 105) return "1 分钟前";
        else if (b < 3345) {
            b = Math.floor(b / 60) + (b % 60 >= 45 ? 1 : 0);
            return "1 分钟前".replace("1", b + "")
        } else if (b < 6600) return "1小时前";
        else {
            b = Math.floor(b / 3600) + (b % 3600 >= 3E3 ? 1 : 0);
            return "1 小时前".replace("1", b + "")
        }
        return g
    }
    function xa(a, c, b, d) {
